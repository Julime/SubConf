...
<?php include "read.php"; ?>
       ...
       <li class="list-group-item group-li" id="<?php echo str_replace(" ","_",$gutscheine["name"]); ?>-li-nav">
        ...
        <button type="button" class="btn btn-primary save-btn " id="savebtngutschein" data-loading-text="Wird gespeichert ..." data-complete-text="Gespeichert!"><?php echo $config["Text"]["Save-btn"]; ?></button>
            ...
            <?php if (!array_key_exists("count",$gutscheine)) { ?>
                ...
                <?php foreach ($gutscheine as $Sub)
                {
                    if (is_array($Sub) and array_key_exists("dates",$Sub)) { ?>
                        ...
                        <button type="button" class="entfernen btn btn-default" value="<?php echo str_replace(" ","_",$gutscheine["name"]); echo str_replace(" ","_",$Sub["name"]); ?>"><?php echo $config["Text"]["Delete-btn"]; ?></button>
                        <br>name:
