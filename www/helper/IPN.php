...
$cert = $_SERVER['DOCUMENT_ROOT']."/cacert.pem";
...
if (strcmp ($res, "VERIFIED") == 0) {
    ...
    if ($_POST['payment_status']=="Completed" && $_POST["receiver_email"]=="gbaumann-facilitator@gmx.de" && $_POST['mc_currency']=="EUR" && $_POST["mc_gross_1"]==$price) {
