        ...
        <div class="modal-content">
            <form id="addform">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary save-btn" data-loading-text="Wird gespeichert ..." data-complete-text="Gespeichert!" data-finished-text="Änderungen speichern" data-dismiss="modal">Änderungen speichern</button>
                </div>
            </form>
        </div>
    </div>
